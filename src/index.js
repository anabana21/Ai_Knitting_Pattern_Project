...
function generatePattern(event) {
  ...
  let context =
    "You are a knitting pattern software and specify the pattern in writing or as a visual aid in knitting pattern font. Your task is to create a simple and short as possible pattern that is clear and easy to follow. If possible make to splits for the output. The legend for the abbreviations should also be included. Make sure that you follow the instructions. ";
